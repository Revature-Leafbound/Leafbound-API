...
public class ProductControllerTest {
	...
	static void setUpBeforeClass() throws Exception {
		...
		mockProduct1 = new Product(uuid1, "Autho Name 1", "Publisher's Name 1", "ISBN number 1", "Book Genre 1",
				"Book title 1", "Book Language 1", "1998-3-1", "Book Edition 1", 9.99);
		mockProduct2 = new Product(uuid2, "Autho Name 2", "Publisher's Name 2", "ISBN number 2", "Book Genre 2",
				"Book title 2", "Book Language 2", "1974-5-5", "Book Edition 2", 7.99);

		mockProductCreation = new Product(uuid3, "Autho Create 2", "Publisher's Create 2", "ISBN Create 2",
				"Create Genre 2", "Create title 2", "Create Language 2", "1974-5-5", "Book Edition 2", 75.99);
		...
		mockProductDeletion = new Product(4, "Autho Name 4", "Publisher's Name 4", "ISBN number 4", "Book Genre 4",
				"Book title 4", "Book Language 4", "1944-4-4", "Book Edition 4", 47.99);
